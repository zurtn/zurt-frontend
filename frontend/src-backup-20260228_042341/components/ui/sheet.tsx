  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        {/* Always include a hidden title as fallback for accessibility */}
        {/* If a component provides its own SheetTitle, both will exist but screen readers will use the visible one */}
